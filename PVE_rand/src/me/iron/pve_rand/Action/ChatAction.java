...
public class ChatAction extends CustomAction implements Serializable {
     ...
     */
    public ChatAction(int argument, String description, String message, int range) {
        super(argument, description);
        this.message = message;
        this.range = range;
    }

    public ChatAction(int argument, String description, String message, int range, boolean showSector) {
        super(argument, description);
        this.message = message;
        this.range = range;
